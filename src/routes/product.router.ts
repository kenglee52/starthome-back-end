...
import { getTypeCount, getProductCount, getProducts, createProduct, updateProduct, deleteProduct, searchAllProducts, getProductAutoId, removeProductMediaByIndex, addImageToProduct, addVideoToProduct } from "../controllers/product.controller";
const router = Router();
